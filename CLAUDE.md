...
갈무리11은 11의 배수(11·22·33·44)에서 가장 또렷합니다. 그래서 크게 보이는 글자만 그 크기입니다 — 제목 22, 숫자 버튼 22, 결과 22, 정답 칸 44.
...
**PC에서 세로 가운데 정렬을 하지 마세요.** 화면이 커서 허전해 보이지만, 기록이 한 줄 쌓일 때마다 판 전체가 위로 밀립니다. 누르려던 순간에 숫자 버튼이 도망가므로 위의 '나타났다 사라지는 요소' 규칙과 같은 문제입니다.
